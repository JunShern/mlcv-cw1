...
title('Accuracy vs k for Split Num (Trees = 160, Depth = 10)', 'FontSize', 20);
xlabel('Codebook size (Number of Clusters, k)', 'FontSize', 15);
ylabel('Accuracy (0-1)', 'FontSize', 15);
...
title('Training Duration vs k for Split Num (Trees = 160, Depth = 10)', 'FontSize', 20);
xlabel('Codebook size (Number of Clusters, k)', 'FontSize', 15);
ylabel('Time (s)', 'FontSize', 15);
lgd = legend('2', '16', '64', '128', 'Location', 'southeast');
title(lgd, 'Tree depth');
...
title('Testing Duration vs k for Split Num (Trees = 160, Depth = 10)', 'FontSize', 20);
xlabel('Codebook size (Number of Clusters, k)', 'FontSize', 15);
ylabel('Time (s)', 'FontSize', 15);
lgd = legend('2', '16', '64', '128', 'Location', 'southeast');
title(lgd, 'Tree depth');
