...
axis([0.5 3.5 0 1]);
title('Leaf 1, tree 1','FontSize', 40);
%set(findall(gcf,'type','axes'),'fontsize', 12);

%% subplot(1,4,2);
bar(trees(1).leaf(2).prob);
axis([0.5 3.5 0 1]);
title('Leaf 2, tree 1','FontSize', 40);

%% subplot(1,4,3);
bar(trees(1).leaf(3).prob);
axis([0.5 3.5 0 1]);
title('Leaf 3, tree 1','FontSize', 40);

%% subplot(1,4,4);
bar(trees(1).leaf(4).prob);
axis([0.5 3.5 0 1]);
title('Leaf 4, tree 1','FontSize', 40);

%% subplot(2,4,1);
bar(trees(1).leaf(5).prob);
axis([0.5 3.5 0 1]);
title('Leaf 5, tree 1','FontSize', 40);

%% subplot(2,4,2);
bar(trees(1).leaf(6).prob);
axis([0.5 3.5 0 1]);
title('Leaf 6, tree 1','FontSize', 40);

%% subplot(2,4,3);
bar(trees(1).leaf(7).prob);
axis([0.5 3.5 0 1]);
title('Leaf 7, tree 1','FontSize', 40);

%% subplot(2,4,4);
bar(trees(1).leaf(8).prob);
axis([0.5 3.5 0 1]);
title('Leaf 8, tree 1','FontSize', 40);

%% subplot(3,4,1);
bar(trees(1).leaf(9).prob);
axis([0.5 3.5 0 1]);
title('Leaf 9, tree 1','FontSize', 40);

%% subplot(3,4,2);
bar(trees(1).leaf(10).prob);
axis([0.5 3.5 0 1]);
title('Leaf 10, tree 1','FontSize', 40);

%% subplot(3,4,3);
bar(trees(1).leaf(11).prob);
axis([0.5 3.5 0 1]);
title('Leaf 11, tree 1','FontSize', 40);

%% subplot(3,4,4);
bar(trees(1).leaf(12).prob);
axis([0.5 3.5 0 1]);
title('Leaf 12, tree 1','FontSize', 40);
...
leaves = testTrees(test_point,trees);
p_rf = trees(1).prob(leaves,:);
p_rf_sum = [sum(reshape(p_rf(:,1),[length(test_point),param.num]),2)...
    sum(reshape(p_rf(:,2),[length(test_point),param.num]),2)...
    sum(reshape(p_rf(:,3),[length(test_point),param.num]),2)]./param.num;
    
test_points_leaves(p_rf, p_rf_sum);

[~,test_point(:,3)] = max(p_rf_sum');

%% 
figure;
plot_toydata(test_point, 'train');
plot_toydata(data_train, 'test');
title('Test points evaluation', 'FontSize', 40)
